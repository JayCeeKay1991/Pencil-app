...
import { login, getArtists, getArtist, getProjects, getProject, addProject, addArtistToProject, addLike, getLikes, addDislike, getDislikes, addComment, getComments} from "./controller/controller";
...
myRouter.get("/projects/comments/:projectId/:artistId", getComments);
